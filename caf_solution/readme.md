...
For a review of the hierarchy approach of Cloud Adoption Framework for Azure landing zones on Terraform, you can refer to [the following documentation](https://github.com/aztfmodnew/caf-terraform-landingzones/blob/master/documentation/code_architecture/hierarchy.md).

## Deploying solutions

Solution examples are available in the CAF Landing zones Starter repo: https://github.com/aztfmodnew/caf-terraform-landingzones-starter